...
declare namespace $.$$ {
    class $visavis_upload extends $.$visavis_upload {
        receive(data: DataTransfer): void;
        open_dialog(): void;
    }
}
...
declare namespace $ {
    class $visavis_matrix extends $mol_page {
        ...
        Order(): $$.$mol_select;
        heatmap_lowest(): string;
        heatmap_color(id: any): string;
        Heatmap_color(id: any): $mol_view;
        heatmap_color_list(): readonly any[];
        Heatmap_colors(): $mol_view;
        heatmap_higest(): string;
        Heatmap_legend(): $mol_view;
